...
function LetterList() {
  ...
  const renderRightContent = () => {
    ...
    return (
      <div className="grid grid-cols-2 gap-24 xl:gap-8 tablet2560:gap-40 p-8">
        {letters.map((letter, index) => (
          ...
          >
            ...
            <div className="text-maplestory font-bold xl:top-20 xl:text-base xl:left-5 absolute top-8 tablet2560:left-8 tablet2560:text-2xl tablet2560:mt-20 ms-6 text-gray-600">{letter.date}</div>
