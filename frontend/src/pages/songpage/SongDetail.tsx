    ...
    <div className="fixed inset-0 w-screen h-screen flex flex-col items-center justify-center">
      ...
      {songUrl ? (
        <div className="w-full h-full">
          <video ref={videoRef} controls className="w-full h-full object-cover" onEnded={() => navigate("/songend")}>
        ...
        <div
          className="fixed inset-0 w-screen h-screen bg-cover bg-center pointer-events-none"
        ...
        >
          ...
          <div className="fixed bottom-12 left-0 w-full flex justify-center gap-8">
            ...
            <img
              src={Bear}
              alt="Bear"
              className=" w-[25vw] h-[25vw] max-w-[1200px] min-w-[100px] self-end animate-shake2"
            />
            <img
              src={Cat2}
              alt="Cat2"
              className=" w-[17vw] h-[23vw] max-w-[1200px] min-w-[100px] self-start animate-shake1"
            />
            <img
              src={Monkey}
              alt="Monkey"
              className=" w-[20vw] h-[24vw] max-w-[1200px] min-w-[100px] self-end animate-shake2"
            />
          </div>
        </div>
      )}
